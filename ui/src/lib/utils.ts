...
export async function impersonateAsSuperadmin(params: {
  ...
  // (served from the target sub-domain, e.g. voice.tevrixai.com). The route will set the
  ...
  // superadmin.dograh.com we want to switch to voice.tevrixai.com. For any other domain
