...
export type MpsBillingCreditsResponse = { credits?: number; [key: string]: unknown };
export type MpsCreditLedgerEntryResponse = { amount?: number; description?: string; [key: string]: unknown };
