 ...
 * Get Agent
 *
 * Return the current agent configuration for this company.
 */
export const getAgentApiV1CrmAgentGet = <ThrowOnError extends boolean = false>(options?: Options<GetAgentApiV1CrmAgentGetData, ThrowOnError>) => (options?.client ?? client).get<GetAgentApiV1CrmAgentGetResponses, GetAgentApiV1CrmAgentGetErrors, ThrowOnError>({ url: '/api/v1/crm/agent', ...options });

/**
 * Update Agent
 *
 * Update agent config (saves as a draft; use /publish to go live).
 */
export const updateAgentApiV1CrmAgentPut = <ThrowOnError extends boolean = false>(options: Options<UpdateAgentApiV1CrmAgentPutData, ThrowOnError>) => (options.client ?? client).put<UpdateAgentApiV1CrmAgentPutResponses, UpdateAgentApiV1CrmAgentPutErrors, ThrowOnError>({
    url: '/api/v1/crm/agent',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * Publish Agent
 *
 * Publish the current draft to make it the live version.
 */
export const publishAgentApiV1CrmAgentPublishPost = <ThrowOnError extends boolean = false>(options?: Options<PublishAgentApiV1CrmAgentPublishPostData, ThrowOnError>) => (options?.client ?? client).post<PublishAgentApiV1CrmAgentPublishPostResponses, PublishAgentApiV1CrmAgentPublishPostErrors, ThrowOnError>({ url: '/api/v1/crm/agent/publish', ...options });

/**
 * Test Call
 *
 * Place a test call to a phone number using the draft agent.
 */
export const testCallApiV1CrmAgentTestCallPost = <ThrowOnError extends boolean = false>(options: Options<TestCallApiV1CrmAgentTestCallPostData, ThrowOnError>) => (options.client ?? client).post<TestCallApiV1CrmAgentTestCallPostResponses, TestCallApiV1CrmAgentTestCallPostErrors, ThrowOnError>({
    url: '/api/v1/crm/agent/test-call',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * List Voices
 *
 * Return available TTS voices for India.
 */
export const listVoicesApiV1CrmAgentVoicesGet = <ThrowOnError extends boolean = false>(options?: Options<ListVoicesApiV1CrmAgentVoicesGetData, ThrowOnError>) => (options?.client ?? client).get<ListVoicesApiV1CrmAgentVoicesGetResponses, ListVoicesApiV1CrmAgentVoicesGetErrors, ThrowOnError>({ url: '/api/v1/crm/agent/voices', ...options });

/**
 * List Calls
 */
export const listCallsApiV1CrmCallsCallsGet = <ThrowOnError extends boolean = false>(options?: Options<ListCallsApiV1CrmCallsCallsGetData, ThrowOnError>) => (options?.client ?? client).get<ListCallsApiV1CrmCallsCallsGetResponses, ListCallsApiV1CrmCallsCallsGetErrors, ThrowOnError>({ url: '/api/v1/crm/calls/calls', ...options });

/**
 * Start Call
 *
 * Place a single outbound call to a customer using the company's default agent.
 */
export const startCallApiV1CrmCallsCallsPost = <ThrowOnError extends boolean = false>(options: Options<StartCallApiV1CrmCallsCallsPostData, ThrowOnError>) => (options.client ?? client).post<StartCallApiV1CrmCallsCallsPostResponses, StartCallApiV1CrmCallsCallsPostErrors, ThrowOnError>({
    url: '/api/v1/crm/calls/calls',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * Get Call
 */
export const getCallApiV1CrmCallsCallsCallIdGet = <ThrowOnError extends boolean = false>(options: Options<GetCallApiV1CrmCallsCallsCallIdGetData, ThrowOnError>) => (options.client ?? client).get<GetCallApiV1CrmCallsCallsCallIdGetResponses, GetCallApiV1CrmCallsCallsCallIdGetErrors, ThrowOnError>({ url: '/api/v1/crm/calls/calls/{call_id}', ...options });

/**
 * List Campaigns
 */
export const listCampaignsApiV1CrmCampaignsCampaignsGet = <ThrowOnError extends boolean = false>(options?: Options<ListCampaignsApiV1CrmCampaignsCampaignsGetData, ThrowOnError>) => (options?.client ?? client).get<ListCampaignsApiV1CrmCampaignsCampaignsGetResponses, ListCampaignsApiV1CrmCampaignsCampaignsGetErrors, ThrowOnError>({ url: '/api/v1/crm/campaigns/campaigns', ...options });

/**
 * Create Campaign
 *
 * Create a campaign (does NOT start it yet — use /start).
 */
export const createCampaignApiV1CrmCampaignsCampaignsPost = <ThrowOnError extends boolean = false>(options: Options<CreateCampaignApiV1CrmCampaignsCampaignsPostData, ThrowOnError>) => (options.client ?? client).post<CreateCampaignApiV1CrmCampaignsCampaignsPostResponses, CreateCampaignApiV1CrmCampaignsCampaignsPostErrors, ThrowOnError>({
    url: '/api/v1/crm/campaigns/campaigns',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * Start Campaign
 *
 * Resolve the customer selection, create the Dograh campaign, and start dialing.
 */
export const startCampaignApiV1CrmCampaignsCampaignsCampaignIdStartPost = <ThrowOnError extends boolean = false>(options: Options<StartCampaignApiV1CrmCampaignsCampaignsCampaignIdStartPostData, ThrowOnError>) => (options.client ?? client).post<StartCampaignApiV1CrmCampaignsCampaignsCampaignIdStartPostResponses, StartCampaignApiV1CrmCampaignsCampaignsCampaignIdStartPostErrors, ThrowOnError>({ url: '/api/v1/crm/campaigns/campaigns/{campaign_id}/start', ...options });

/**
 * Pause Campaign
 */
export const pauseCampaignApiV1CrmCampaignsCampaignsCampaignIdPausePost = <ThrowOnError extends boolean = false>(options: Options<PauseCampaignApiV1CrmCampaignsCampaignsCampaignIdPausePostData, ThrowOnError>) => (options.client ?? client).post<PauseCampaignApiV1CrmCampaignsCampaignsCampaignIdPausePostResponses, PauseCampaignApiV1CrmCampaignsCampaignsCampaignIdPausePostErrors, ThrowOnError>({ url: '/api/v1/crm/campaigns/campaigns/{campaign_id}/pause', ...options });

/**
 * Resume Campaign
 */
export const resumeCampaignApiV1CrmCampaignsCampaignsCampaignIdResumePost = <ThrowOnError extends boolean = false>(options: Options<ResumeCampaignApiV1CrmCampaignsCampaignsCampaignIdResumePostData, ThrowOnError>) => (options.client ?? client).post<ResumeCampaignApiV1CrmCampaignsCampaignsCampaignIdResumePostResponses, ResumeCampaignApiV1CrmCampaignsCampaignsCampaignIdResumePostErrors, ThrowOnError>({ url: '/api/v1/crm/campaigns/campaigns/{campaign_id}/resume', ...options });

/**
 * Get Campaign
 */
export const getCampaignApiV1CrmCampaignsCampaignsCampaignIdGet = <ThrowOnError extends boolean = false>(options: Options<GetCampaignApiV1CrmCampaignsCampaignsCampaignIdGetData, ThrowOnError>) => (options.client ?? client).get<GetCampaignApiV1CrmCampaignsCampaignsCampaignIdGetResponses, GetCampaignApiV1CrmCampaignsCampaignsCampaignIdGetErrors, ThrowOnError>({ url: '/api/v1/crm/campaigns/campaigns/{campaign_id}', ...options });

/**
 * Get Campaign Stats
 *
 * Return aggregated call stats for a campaign.
 */
export const getCampaignStatsApiV1CrmCampaignsCampaignsCampaignIdStatsGet = <ThrowOnError extends boolean = false>(options: Options<GetCampaignStatsApiV1CrmCampaignsCampaignsCampaignIdStatsGetData, ThrowOnError>) => (options.client ?? client).get<GetCampaignStatsApiV1CrmCampaignsCampaignsCampaignIdStatsGetResponses, GetCampaignStatsApiV1CrmCampaignsCampaignsCampaignIdStatsGetErrors, ThrowOnError>({ url: '/api/v1/crm/campaigns/campaigns/{campaign_id}/stats', ...options });

/**
 * Get Campaign Calls
 *
 * Return individual call rows for a campaign.
 */
export const getCampaignCallsApiV1CrmCampaignsCampaignsCampaignIdCallsGet = <ThrowOnError extends boolean = false>(options: Options<GetCampaignCallsApiV1CrmCampaignsCampaignsCampaignIdCallsGetData, ThrowOnError>) => (options.client ?? client).get<GetCampaignCallsApiV1CrmCampaignsCampaignsCampaignIdCallsGetResponses, GetCampaignCallsApiV1CrmCampaignsCampaignsCampaignIdCallsGetErrors, ThrowOnError>({ url: '/api/v1/crm/campaigns/campaigns/{campaign_id}/calls', ...options });

/**
 * Create Company
 *
 * Sign up: create a company and trigger white-label provisioning.
 */
export const createCompanyApiV1CrmCompaniesCompaniesPost = <ThrowOnError extends boolean = false>(options: Options<CreateCompanyApiV1CrmCompaniesCompaniesPostData, ThrowOnError>) => (options.client ?? client).post<CreateCompanyApiV1CrmCompaniesCompaniesPostResponses, CreateCompanyApiV1CrmCompaniesCompaniesPostErrors, ThrowOnError>({
    url: '/api/v1/crm/companies/companies',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * List My Companies
 *
 * List all companies the caller belongs to.
 */
export const listMyCompaniesApiV1CrmCompaniesCompaniesMeGet = <ThrowOnError extends boolean = false>(options?: Options<ListMyCompaniesApiV1CrmCompaniesCompaniesMeGetData, ThrowOnError>) => (options?.client ?? client).get<ListMyCompaniesApiV1CrmCompaniesCompaniesMeGetResponses, ListMyCompaniesApiV1CrmCompaniesCompaniesMeGetErrors, ThrowOnError>({ url: '/api/v1/crm/companies/companies/me', ...options });

/**
 * Get Company
 */
export const getCompanyApiV1CrmCompaniesCompaniesCompanyIdGet = <ThrowOnError extends boolean = false>(options?: Options<GetCompanyApiV1CrmCompaniesCompaniesCompanyIdGetData, ThrowOnError>) => (options?.client ?? client).get<GetCompanyApiV1CrmCompaniesCompaniesCompanyIdGetResponses, GetCompanyApiV1CrmCompaniesCompaniesCompanyIdGetErrors, ThrowOnError>({ url: '/api/v1/crm/companies/companies/{company_id}', ...options });

/**
 * Update Company
 */
export const updateCompanyApiV1CrmCompaniesCompaniesCompanyIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateCompanyApiV1CrmCompaniesCompaniesCompanyIdPatchData, ThrowOnError>) => (options.client ?? client).patch<UpdateCompanyApiV1CrmCompaniesCompaniesCompanyIdPatchResponses, UpdateCompanyApiV1CrmCompaniesCompaniesCompanyIdPatchErrors, ThrowOnError>({
    url: '/api/v1/crm/companies/companies/{company_id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * Get Customer Detail
 *
 * Return a single customer with their recent calls and open follow-ups.
 */
export const getCustomerDetailApiV1CrmCustomersCustomersCustomerIdGet = <ThrowOnError extends boolean = false>(options: Options<GetCustomerDetailApiV1CrmCustomersCustomersCustomerIdGetData, ThrowOnError>) => (options.client ?? client).get<GetCustomerDetailApiV1CrmCustomersCustomersCustomerIdGetResponses, GetCustomerDetailApiV1CrmCustomersCustomersCustomerIdGetErrors, ThrowOnError>({ url: '/api/v1/crm/customers/customers/{customer_id}', ...options });

/**
 * List Customers
 *
 * List customers with optional status/search filters.
 */
export const listCustomersApiV1CrmCustomersCustomersGet = <ThrowOnError extends boolean = false>(options?: Options<ListCustomersApiV1CrmCustomersCustomersGetData, ThrowOnError>) => (options?.client ?? client).get<ListCustomersApiV1CrmCustomersCustomersGetResponses, ListCustomersApiV1CrmCustomersCustomersGetErrors, ThrowOnError>({ url: '/api/v1/crm/customers/customers', ...options });
 ...
 */
export const createCustomersBatchApiV1CrmCustomersCustomersBatchPost = <ThrowOnError extends boolean = false>(options: Options<CreateCustomersBatchApiV1CrmCustomersCustomersBatchPostData, ThrowOnError>) => (options.client ?? client).post<CreateCustomersBatchApiV1CrmCustomersCustomersBatchPostResponses, CreateCustomersBatchApiV1CrmCustomersCustomersBatchPostErrors, ThrowOnError>({
    url: '/api/v1/crm/customers/customers/batch',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 */
export const getSummaryApiV1CrmReportsReportsSummaryGet = <ThrowOnError extends boolean = false>(options?: Options<GetSummaryApiV1CrmReportsReportsSummaryGetData, ThrowOnError>) => (options?.client ?? client).get<GetSummaryApiV1CrmReportsReportsSummaryGetResponses, GetSummaryApiV1CrmReportsReportsSummaryGetErrors, ThrowOnError>({ url: '/api/v1/crm/reports/reports/summary', ...options });
 ...
 * Sign up: create a company and trigger white-label provisioning.
 */
export const createCompanyApiCrmCompaniesPost = <ThrowOnError extends boolean = false>(options: Options<CreateCompanyApiCrmCompaniesPostData, ThrowOnError>) => (options.client ?? client).post<CreateCompanyApiCrmCompaniesPostResponses, CreateCompanyApiCrmCompaniesPostErrors, ThrowOnError>({
 ...
 * List all companies the caller belongs to.
 */
export const listMyCompaniesApiCrmCompaniesMeGet = <ThrowOnError extends boolean = false>(options?: Options<ListMyCompaniesApiCrmCompaniesMeGetData, ThrowOnError>) => (options?.client ?? client).get<ListMyCompaniesApiCrmCompaniesMeGetResponses, ListMyCompaniesApiCrmCompaniesMeGetErrors, ThrowOnError>({ url: '/api/crm/companies/me', ...options });

/**
 * Get Company
 */
export const getCompanyApiCrmCompaniesCompanyIdGet = <ThrowOnError extends boolean = false>(options?: Options<GetCompanyApiCrmCompaniesCompanyIdGetData, ThrowOnError>) => (options?.client ?? client).get<GetCompanyApiCrmCompaniesCompanyIdGetResponses, GetCompanyApiCrmCompaniesCompanyIdGetErrors, ThrowOnError>({ url: '/api/crm/companies/{company_id}', ...options });

/**
 * Update Company
 */
export const updateCompanyApiCrmCompaniesCompanyIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateCompanyApiCrmCompaniesCompanyIdPatchData, ThrowOnError>) => (options.client ?? client).patch<UpdateCompanyApiCrmCompaniesCompanyIdPatchResponses, UpdateCompanyApiCrmCompaniesCompanyIdPatchErrors, ThrowOnError>({
    url: '/api/crm/companies/{company_id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * Return a single customer with their recent calls and open follow-ups.
 */
export const getCustomerDetailApiCrmCustomersCustomerIdGet = <ThrowOnError extends boolean = false>(options: Options<GetCustomerDetailApiCrmCustomersCustomerIdGetData, ThrowOnError>) => (options.client ?? client).get<GetCustomerDetailApiCrmCustomersCustomerIdGetResponses, GetCustomerDetailApiCrmCustomersCustomerIdGetErrors, ThrowOnError>({ url: '/api/crm/customers/{customer_id}', ...options });
 ...
 * List customers with optional status/search filters.
 */
export const listCustomersApiCrmCustomersGet = <ThrowOnError extends boolean = false>(options?: Options<ListCustomersApiCrmCustomersGetData, ThrowOnError>) => (options?.client ?? client).get<ListCustomersApiCrmCustomersGetResponses, ListCustomersApiCrmCustomersGetErrors, ThrowOnError>({ url: '/api/crm/customers', ...options });
 ...
 * Bulk create customers.
 */
export const createCustomersBatchApiCrmCustomersBatchPost = <ThrowOnError extends boolean = false>(options: Options<CreateCustomersBatchApiCrmCustomersBatchPostData, ThrowOnError>) => (options.client ?? client).post<CreateCustomersBatchApiCrmCustomersBatchPostResponses, CreateCustomersBatchApiCrmCustomersBatchPostErrors, ThrowOnError>({
    url: '/api/crm/customers/batch',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * List Calls
 */
export const listCallsApiCrmCallsGet = <ThrowOnError extends boolean = false>(options?: Options<ListCallsApiCrmCallsGetData, ThrowOnError>) => (options?.client ?? client).get<ListCallsApiCrmCallsGetResponses, ListCallsApiCrmCallsGetErrors, ThrowOnError>({ url: '/api/crm/calls', ...options });
 ...
 * Place a single outbound call to a customer using the company's default agent.
 */
export const startCallApiCrmCallsPost = <ThrowOnError extends boolean = false>(options: Options<StartCallApiCrmCallsPostData, ThrowOnError>) => (options.client ?? client).post<StartCallApiCrmCallsPostResponses, StartCallApiCrmCallsPostErrors, ThrowOnError>({
    url: '/api/crm/calls',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * Get Call
 */
export const getCallApiCrmCallsCallIdGet = <ThrowOnError extends boolean = false>(options: Options<GetCallApiCrmCallsCallIdGetData, ThrowOnError>) => (options.client ?? client).get<GetCallApiCrmCallsCallIdGetResponses, GetCallApiCrmCallsCallIdGetErrors, ThrowOnError>({ url: '/api/crm/calls/{call_id}', ...options });

/**
 * List Campaigns
 */
export const listCampaignsApiCrmCampaignsGet = <ThrowOnError extends boolean = false>(options?: Options<ListCampaignsApiCrmCampaignsGetData, ThrowOnError>) => (options?.client ?? client).get<ListCampaignsApiCrmCampaignsGetResponses, ListCampaignsApiCrmCampaignsGetErrors, ThrowOnError>({ url: '/api/crm/campaigns', ...options });
 ...
 * Create a campaign (does NOT start it yet — use /start).
 */
export const createCampaignApiCrmCampaignsPost = <ThrowOnError extends boolean = false>(options: Options<CreateCampaignApiCrmCampaignsPostData, ThrowOnError>) => (options.client ?? client).post<CreateCampaignApiCrmCampaignsPostResponses, CreateCampaignApiCrmCampaignsPostErrors, ThrowOnError>({
 ...
 * Resolve the customer selection, create the Dograh campaign, and start dialing.
 */
export const startCampaignApiCrmCampaignsCampaignIdStartPost = <ThrowOnError extends boolean = false>(options: Options<StartCampaignApiCrmCampaignsCampaignIdStartPostData, ThrowOnError>) => (options.client ?? client).post<StartCampaignApiCrmCampaignsCampaignIdStartPostResponses, StartCampaignApiCrmCampaignsCampaignIdStartPostErrors, ThrowOnError>({ url: '/api/crm/campaigns/{campaign_id}/start', ...options });

/**
 * Pause Campaign
 */
export const pauseCampaignApiCrmCampaignsCampaignIdPausePost = <ThrowOnError extends boolean = false>(options: Options<PauseCampaignApiCrmCampaignsCampaignIdPausePostData, ThrowOnError>) => (options.client ?? client).post<PauseCampaignApiCrmCampaignsCampaignIdPausePostResponses, PauseCampaignApiCrmCampaignsCampaignIdPausePostErrors, ThrowOnError>({ url: '/api/crm/campaigns/{campaign_id}/pause', ...options });

/**
 * Resume Campaign
 */
export const resumeCampaignApiCrmCampaignsCampaignIdResumePost = <ThrowOnError extends boolean = false>(options: Options<ResumeCampaignApiCrmCampaignsCampaignIdResumePostData, ThrowOnError>) => (options.client ?? client).post<ResumeCampaignApiCrmCampaignsCampaignIdResumePostResponses, ResumeCampaignApiCrmCampaignsCampaignIdResumePostErrors, ThrowOnError>({ url: '/api/crm/campaigns/{campaign_id}/resume', ...options });

/**
 * Get Campaign
 */
export const getCampaignApiCrmCampaignsCampaignIdGet = <ThrowOnError extends boolean = false>(options: Options<GetCampaignApiCrmCampaignsCampaignIdGetData, ThrowOnError>) => (options.client ?? client).get<GetCampaignApiCrmCampaignsCampaignIdGetResponses, GetCampaignApiCrmCampaignsCampaignIdGetErrors, ThrowOnError>({ url: '/api/crm/campaigns/{campaign_id}', ...options });
 ...
 * Return aggregated call stats for a campaign.
 */
export const getCampaignStatsApiCrmCampaignsCampaignIdStatsGet = <ThrowOnError extends boolean = false>(options: Options<GetCampaignStatsApiCrmCampaignsCampaignIdStatsGetData, ThrowOnError>) => (options.client ?? client).get<GetCampaignStatsApiCrmCampaignsCampaignIdStatsGetResponses, GetCampaignStatsApiCrmCampaignsCampaignIdStatsGetErrors, ThrowOnError>({ url: '/api/crm/campaigns/{campaign_id}/stats', ...options });
 ...
 * Return individual call rows for a campaign.
 */
export const getCampaignCallsApiCrmCampaignsCampaignIdCallsGet = <ThrowOnError extends boolean = false>(options: Options<GetCampaignCallsApiCrmCampaignsCampaignIdCallsGetData, ThrowOnError>) => (options.client ?? client).get<GetCampaignCallsApiCrmCampaignsCampaignIdCallsGetResponses, GetCampaignCallsApiCrmCampaignsCampaignIdCallsGetErrors, ThrowOnError>({ url: '/api/crm/campaigns/{campaign_id}/calls', ...options });
 ...
 * Return the current agent configuration for this company.
 */
export const getAgentApiCrmAgentGet = <ThrowOnError extends boolean = false>(options?: Options<GetAgentApiCrmAgentGetData, ThrowOnError>) => (options?.client ?? client).get<GetAgentApiCrmAgentGetResponses, GetAgentApiCrmAgentGetErrors, ThrowOnError>({ url: '/api/crm/agent', ...options });
 ...
 * Update agent config (saves as a draft; use /publish to go live).
 */
export const updateAgentApiCrmAgentPut = <ThrowOnError extends boolean = false>(options: Options<UpdateAgentApiCrmAgentPutData, ThrowOnError>) => (options.client ?? client).put<UpdateAgentApiCrmAgentPutResponses, UpdateAgentApiCrmAgentPutErrors, ThrowOnError>({
    url: '/api/crm/agent',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * Publish the current draft to make it the live version.
 */
export const publishAgentApiCrmAgentPublishPost = <ThrowOnError extends boolean = false>(options?: Options<PublishAgentApiCrmAgentPublishPostData, ThrowOnError>) => (options?.client ?? client).post<PublishAgentApiCrmAgentPublishPostResponses, PublishAgentApiCrmAgentPublishPostErrors, ThrowOnError>({ url: '/api/crm/agent/publish', ...options });
 ...
 * Place a test call to a phone number using the draft agent.
 */
export const testCallApiCrmAgentTestCallPost = <ThrowOnError extends boolean = false>(options: Options<TestCallApiCrmAgentTestCallPostData, ThrowOnError>) => (options.client ?? client).post<TestCallApiCrmAgentTestCallPostResponses, TestCallApiCrmAgentTestCallPostErrors, ThrowOnError>({
    url: '/api/crm/agent/test-call',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * Return available TTS voices for India.
 */
export const listVoicesApiCrmAgentVoicesGet = <ThrowOnError extends boolean = false>(options?: Options<ListVoicesApiCrmAgentVoicesGetData, ThrowOnError>) => (options?.client ?? client).get<ListVoicesApiCrmAgentVoicesGetResponses, unknown, ThrowOnError>({ url: '/api/crm/agent/voices', ...options });
 ...
 * Return KPI summary for the dashboard.
 */
export const getSummaryApiCrmReportsSummaryGet = <ThrowOnError extends boolean = false>(options?: Options<GetSummaryApiCrmReportsSummaryGetData, ThrowOnError>) => (options?.client ?? client).get<GetSummaryApiCrmReportsSummaryGetResponses, GetSummaryApiCrmReportsSummaryGetErrors, ThrowOnError>({ url: '/api/crm/reports/summary', ...options });
