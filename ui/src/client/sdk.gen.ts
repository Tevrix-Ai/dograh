...
export const getCurrentOrganizationContextApiV1OrganizationsContextGet = <ThrowOnError extends boolean = false>(options?: Options<Record<string, never>, ThrowOnError>) => (options?.client ?? client).get<{ 200: Record<string, unknown> }, unknown, ThrowOnError>({ url: '/api/v1/organizations/context', ...options });

export const getUserOnboardingStateApiV1UserOnboardingStateGet = <ThrowOnError extends boolean = false>(options?: Options<Record<string, never>, ThrowOnError>) => (options?.client ?? client).get<{ 200: Record<string, unknown> }, unknown, ThrowOnError>({ url: '/api/v1/user/onboarding-state', ...options });

export const updateUserOnboardingStateApiV1UserOnboardingStatePut = <ThrowOnError extends boolean = false>(options?: Options<{ body: Record<string, unknown> }, ThrowOnError>) => (options?.client ?? client).put<{ 200: Record<string, unknown> }, unknown, ThrowOnError>({ url: '/api/v1/user/onboarding-state', ...options });

export const createMpsCreditPurchaseUrlApiV1OrganizationsUsageMpsCreditsPurchaseUrlPost = <ThrowOnError extends boolean = false>(options?: Options<Record<string, never>, ThrowOnError>) => (options?.client ?? client).post<{ 200: { checkout_url: string } }, unknown, ThrowOnError>({ url: '/api/v1/organizations/usage/mps-credits/purchase-url', ...options });
